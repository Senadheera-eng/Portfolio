...
import { AnimatedSection, AnimatedCard, StaggerContainer, StaggerItem } from './ui/animated-section';
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            >
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <span className="text-foreground font-semibold"> University of Sri Jayewardenepura</span>, 
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                >
                  Firebase
                </motion.span>, I've developed applications 
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <span className="text-accent font-medium"> all-island chess player</span>.
              </p>

              {/* Quick Info Pills */}
              <div className="flex flex-wrap gap-3 pt-4">
                {['Problem Solver', 'Team Player', 'Quick Learner', 'Chess Enthusiast'].map((tag, index) => (
                  <motion.span
                    key={tag}
            ...
            {[
              {
                icon: GraduationCap,
                title: 'Education',
                lines: ['BSc. Computer Engineering', 'University of Sri Jayewardenepura'],
                highlight: 'GPA: 3.7',
              },
              {
                icon: MapPin,
              ...
              },
              {
                icon: Target,
                title: 'Goal',
                lines: ['Seeking an internship in software development to apply my skills and grow with a professional team.'],
                highlight: null,
              },
            ].map((card, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {card.highlight && (
                        <p className="text-primary font-mono text-sm mt-2 font-semibold">{card.highlight}</p>
                      )}
                    </div>
                  </div>
                </motion.div>
